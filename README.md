...
| --epochs     | number of epoches to train the CoT                     | Ex: epochs=200  default:20      |
| --batch_size | batch size                                             | Ex: batch_size=32  default:32   |
| --lr         | learning rate                                          | Ex: lr=0.0005  default:0.0001   |
| --max_k      | maximum number of clusters to consider                 | Ex: max_k=30  default:8         |
...
| --cov_type   | the covariance shape of each mixture component         | Ex: d_seg='tied' default:'full' |
...
```
CloneHMM('../data/lrc_example.txt','../data/label.txt','../data',10)
```
